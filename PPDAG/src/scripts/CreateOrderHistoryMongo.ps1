...
$mongoCollectionName = "ordershistory"
...
Write-Host "Creating MongoDB Order History..." -ForegroundColor Yellow
...
Write-Host ("Creating " + $mongoCollectionName + " collection...") -ForegroundColor Yellow
$commandResult = $database.CreateCollection($mongoCollectionName)
if (!$commandResult.Ok)
{
    Write-Error ("Failed to drop " + $mongoCollectionName + " collection.")
    exit
...
Write-Host "Creating orderCode index..." -ForegroundColor Yellow
$collection.EnsureIndex("orderCode")
Write-Host "Index created successfully." -ForegroundColor Green

Write-Host "Creating customerId index..." -ForegroundColor Yellow
$collection.EnsureIndex("customerId")
Write-Host "Index created successfully." -ForegroundColor Green

Write-Host "Order History creation complete." -ForegroundColor Green
# SIG # Begin signature block
# MIIasQYJKoZIhvcNAQcCoIIaojCCGp4CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOpGYXVvpGozX6E+w1NDVVxgq
# wL+gghWCMIIEwzCCA6ugAwIBAgITMwAAADQkMUDJoMF5jQAAAAAANDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFNKx
# 1Bj/q4VAcV/PnVqpXp6kDlg5MFIGCisGAQQBgjcCAQwxRDBCoBqAGABwAG4AcABk
# AGEAZwBzAGMAcgBpAHAAdKEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vcHJh
# Y3RpY2VzMA0GCSqGSIb3DQEBAQUABIIBALcQFRZ6UvWwfiurFXtAKU2blKnbdOXj
# WYdb9P8QJqNt1U+aR+U3W0MXBn1jAunO+OfvNlh+2nXKQnQsd+6jTW/a78IQ9zTg
# dvpk/cbL+OuP+X0z9xWQ7G4QpsqqVPH9ONibaMRLmFWc7BYHVVXIKWl29oRN56xA
# JcnioM0rvuHF3LkZ7mDkB5mxnY2xDaUnoi3Oy/HvrHr/p98vd0heOeSSpTpIQ88M
# PtebrHXeopJl5cpl6N6SyaeMqu1aYOH0w5+3iENkBKfvP0tKhIb/dBdyBtS3NeDZ
# 2PpV+6525NtDODrw+4tVnOgzaEZ/2ssXmyJ25Yz6b/dJMf9hcV49D+mhggIoMIIC
...
# CSqGSIb3DQEJBDEWBBQugw74nF21VBxHzpnh4CLCWjZoKTANBgkqhkiG9w0BAQUF
# AASCAQAuakXqaULLu1vMW6fyCCOXK9Kf8phe9Z/ZJ4BLdI2O/dFneJsacpCCnotx
# j76hLwWHjiIYAiQaEowIal1h32OkOTf3SlGdN9BtMWFYWYvSOTelsJ+EFDGU0liz
# DVJ0wo6qwBTTyAEiMjJT1PP5J755MYIJfC7hVUH+8NCmtGg4jp5glspAqmw5qfT3
# i5sbQVSUzSjP00k5dzLv5peYekdRtCewdk1IOzYw9NMXK42vx/3l3aGlMEipSYj9
# JiHU2XxirqsHgxSMdHx51Qri+zpSKHs8a2Kg5FsVD73lNXBucLf1EbhVSWiYvro8
# 6pm0pea9cJeZFlJ8a3lb0j/ZgPnb
